...
cd $(cat /tmp/whereami || echo "$HOME" 2> /dev/null)
...
export SDKMAN_DIR="/home/atix/.sdkman"
[[ -s "/home/atix/.sdkman/bin/sdkman-init.sh" ]] && source "/home/atix/.sdkman/bin/sdkman-init.sh"



alias clone_review="GIT_SSH_COMMAND='ssh -i ~/.ssh/id_rsa_reviews' git clone"
